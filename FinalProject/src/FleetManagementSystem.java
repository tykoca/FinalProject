...
/**
 * FleetManagementSystem class manages a fleet of boats, allowing operations such as adding, removing,
 * and printing boats, as well as managing expenses
 */
public class FleetManagementSystem {
    ...
    /**
     * Makes a FleetManagementSystem instance and initializes the fleet and keyboard input.
     */
    ...
    public static void main(String[] args) {
        FleetManagementSystem manager = new FleetManagementSystem();
            ...
            if (args.length > 0) {
                manager.loadData(args[0], true);
            }else {
                manager.loadData("FleetData", false);
            }

        //manager.loadData(args[0]); // Loads fleet data from CSV or database
     ...
     */
    private void loadData(String name, Boolean args) {
        ...
        if (args) {
            System.out.println("Loading from CSV: " + name);
